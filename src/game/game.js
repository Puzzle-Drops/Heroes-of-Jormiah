...
// Update displays when switching to certain tabs
            ...
            showDungeonSelector() {
                ...
                // Banner art served from assets/dungeon_banners/. Names are baked
                // into the SVGs so no separate label overlay is needed.
                const selectorHTML = `
                    <div id="dungeon-banner-selector">
                        <div id="select-dungeon-title">SELECT YOUR DUNGEON</div>
                        <div id="dungeon-banner-container">
                            <div class="dungeon-banner everfall" data-dungeon="everfall" style="background: url('assets/dungeon_banners/hollowed_wilds.svg') center/cover;"></div>
                            <div class="dungeon-banner stoneforge" data-dungeon="stoneforge" style="background: url('assets/dungeon_banners/iron_vaults.svg') center/cover;"></div>
                            <div class="dungeon-banner umbral" data-dungeon="umbral" style="background: url('assets/dungeon_banners/whispering_spires.svg') center/cover;"></div>
                            <div class="dungeon-banner vault" data-dungeon="vault" style="background: url('assets/dungeon_banners/the_vault.svg') center/cover; ${this.vaultKeys.length === 0 ? 'filter: grayscale(100%) brightness(0.5); opacity: 0.6;' : ''}"></div>
                            <div class="dungeon-banner runetrial" data-dungeon="runetrial" style="background: url('assets/dungeon_banners/rune_trials.svg') center/cover; ${this.runeTrialKeys.length === 0 ? 'filter: grayscale(100%) brightness(0.5); opacity: 0.6;' : ''}"></div>
                        </div>
                    </div>
                `;
